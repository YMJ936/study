...
public class PagingUtil2 {
	 ...
	 * */
	public PagingUtil2(int currentPage, int totalCount, int blockCount,
	...
	public PagingUtil2(String keyField, String keyWord, int currentPage, int totalCount, int blockCount,
			int blockPage,String pageUrl) {
		this(null,null,currentPage,totalCount,blockCount,blockPage,pageUrl,null);
	}
	public PagingUtil2(String keyField, String keyWord, int currentPage, int totalCount, int blockCount,
